...
The NewDataAverage has 180 observations of 88 variables. The first two columns indicate the participant(subject), 
...
Laying). The remaining 86 columns are all averages of 86 different measurements taken by each participant,
doing each activity. Therefore, since there are 30 participants doing 6 activities, we have 180 observations. 
